        ...
        client.getGroupMembersId(id)
            .then((ids) => {
                ...
                if (ids.length <= 10) {
                    ...
                    client.sendText(id, `🥰Hello group members *${name}* 💕, teriamaksih telah mengundang bot,setelah bot masuk silahkan follow ig https://instagram.com/ilham.bsmr,minimal 10 follow dalam setiap grup,jika tidak bot akan out dari grup dalam ⏳ 1 hari,teriama kasih🎎, to see the bot menu send *#menu*`)
                }
            }))
